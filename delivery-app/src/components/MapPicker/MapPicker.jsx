...
function loadGM(cb) {
    ...
    if (_loading) return;
    _loading = true;
    window.__gmDeliveryReady = () => { _loaded = true; _loading = false; _cbs.forEach(f => f()); _cbs = []; };
    const s = document.createElement('script');
    s.src = `https://maps.googleapis.com/maps/api/js?key=${GMAP_KEY}&libraries=places&callback=__gmDeliveryReady&loading=async`;
            ...
            <div className="map-picker-modal" onClick={(e) => e.stopPropagation()}>
                <div className="map-picker-header">
                    <div>
                        ...
                        <p>Search, drag the pin, or tap to set your exact position</p>
                    </div>
                ...
                <div className="map-picker-body" style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0' }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                        <input
                            ref={searchInputRef}
                            type="text"
                    ...
                    <div className="map-picker-address">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
